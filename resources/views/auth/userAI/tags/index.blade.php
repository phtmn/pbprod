            ...
            <div class="card border-3 py-1 p-md-2 p-xl-3 p-xxl-4">
                <div class="card-body">
                    <div class="d-flex align-items-center mt-sm-n1 pb-4 mb-0 mb-lg-1 mb-xl-3">
                        <div class="h4 mb-0">
                            <a class="btn btn-secondary bg text-dark  me-3 me-sm-4" type="button" href="{{ route('tags.create') }}"><i class="ai-plus  ">
                                </i> </a>
                        </div>
                        <div class=" mb-0">
                                    ...
                                    <div class="align-items-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-lg-3 text-end">
                                                <form action="{{ route('tags.destroy', $d->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}

                                                    <a href="{{ route('tags.edit', $d->id) }}" class="badge  text-muted   fs-6 " type="button"> <i class="ai-edit "> </i>
                                                    </a>
