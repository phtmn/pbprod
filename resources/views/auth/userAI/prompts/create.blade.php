                            ...
                            <div class="mb-3 container">
                                ...
                                <div class="col-sm-12 d-flex justify-content-between">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="title" id="title" required placeholder="Título do Prompt">
                                    </div>
                                ...
                                <textarea  class="form-control" name="description" id="description" cols="30" rows="10" style="height: 150px;" placeholder="Para tornar certas partes do prompt editáveis, basta colocá-las entre colchetes [ text ]" required></textarea>

                                <h3 class="mt-3"> <i class="ai-tag fs-5 opacity-60 me-2"></i> Tags</h3>
                                @forelse ($tag as $tag)
                                    <input type="radio" name="tag" value="{{ $tag->id }}" required>
