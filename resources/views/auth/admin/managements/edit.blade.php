        ...
        <div class="col-lg-9 pt-4 pb-1 mt-2 pb-sm-4">
            ...
            <section class="card border-2 py-1 p-md-2 p-xl-3 p-xxl-4 mb-4 ">
                <div class="card-body ">
                    ...
                    <form action="{{ route('managements.update', $managements->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="row mb-3">
                            <div class="col-sm-2">
                                <label class="form-label" for="acronym">Número</label>
                                <input class="form-control" type="text" name="acronym" id="acronym" value="{{ $managements->acronym }}">
                            </div>

                            <div class="col-sm-10">
                                <label class="form-label" for="name">Nome <span class="text-danger">*</span></label>
                                <input class="form-control" type="text" name="name" id="name" value="{{ $managements->name }}" required placeholder="Nome da Gerência">
                                @error('name')
